...
- **Dashboard web** (FastAPI + DuckDB + Plotly) con ocho vistas operativas: distribución de segmentos, mapa de oportunidades de bundles, estacionalidad por segmento, comparador, evolución de bundles por mes, alertas de clientes en riesgo, movimientos entre segmentos, y drill-down individual.
